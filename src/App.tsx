  ...
  return (
    ...
    <nav className="w-full  shadow-md relative ">
        <div className="bg-gray-900 text-blue-500 w-full m-auto text-center p-2 flex justify-center items-center">
          <div className="">
            <img src="https://gccp-leaderboard-gray.vercel.app/_next/image?url=%2Fassets%2FcloudLg.png&w=48&q=75" alt="me" width="40" height="40" />
          </div>
        ...
        <div className="p-3 flex mob:flex-col m-auto max-w-6xl justify-between items-center">
          ...
          <div className="links mob:py-3 flex justify-center items-center space-x-5">
            <a href="https://chat.whatsapp.com/J1EjBNlkKRd5ONx4eQ57br">
            ...
            <a href="https://www.linkedin.com/in/gdsc-poornima-university-34696528a/">
            ...
            <a href="https://www.instagram.com/gdsc.poornima">
            ...
            <a href="https://twitter.com/gdsc_poornima/">
